...
<head>
    ...
    <style>
        ...
        header {background-image: linear-gradient(rgba(135, 206, 235, 0.1), #FFFFF0), url({{asset('/storage/hawaii-ocean.jpg')}});
                background-size: 100%;  height: 300px;}
        .container {display: flex;}
        .sidebar-wrapper {width: 220px; margin-right: 100px; margin-top: 50px;}
        .main-wrapper {flex: 1;}
        footer {clear: both; height: 230px;
                 background-image: linear-gradient(#FFFFF0, rgba(0, 255, 0, 0.5)), url({{asset('/storage/green.jpg')}}); background-size: auto; 
